...
table_of_model_parameters = linearize_model_at_multiple_points(model_equations, model_parameters, 9, 3); 
% For now the number of theta ranges and number of r ranges is passed into this function as parameter ^
